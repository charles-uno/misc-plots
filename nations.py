...
def main():
    ...
    """
    nations = helpers.load_json("data/nations.json")
    for nation in nations:
        if "population" not in nation or "size_km2" not in nation:
            continue
        nation["density_km2"] = nation["population"]/nation["size_km2"]
    helpers.dump_json(nations, "foo.json")
    return
    """
